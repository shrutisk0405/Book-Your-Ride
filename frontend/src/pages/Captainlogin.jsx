...
const Captainlogin = () => {
  ...
  return (
    ...
    > Login</button>
    <p className='text-center'>Want to Join ? <Link to='/captain-signup' className='text-blue-600 '>Register as Captain</Link></p>
